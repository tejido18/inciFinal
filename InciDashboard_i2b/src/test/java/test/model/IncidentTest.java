...
import com.uniovi.application.InciDashboardI2bApplication;
...
public class IncidentTest {
	...
	public void testEquals() {
		...
		Incident inci2 = new Incident("Aaaaaaaa", new LatLng(53, 42), carmen);
		assertTrue(inci.equals(inciClone));
		assertFalse(inci.equals(carmen));
		inci2.setId(new ObjectId());
	...
	public void testOperator() {
		...
		inci.assignOperator(new Operator("juana@laloca.com", "juana", "ROLE_OPERATOR"));
